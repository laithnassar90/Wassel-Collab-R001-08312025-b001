...
export class LoginFb extends Component {
  ...
  componentDidMount() {
    ...
    if (process.env.NODE_ENV === 'development') {
      appId = process.env.FACEBOOK_APP_ID_DEV || 'dev_app_id'
      version = process.env.FACEBOOK_API_VERSION || 'v2.3'
    } else {
      appId = process.env.FACEBOOK_APP_ID_PROD || 'prod_app_id'
      version = process.env.FACEBOOK_API_VERSION || 'v2.4'
    }
