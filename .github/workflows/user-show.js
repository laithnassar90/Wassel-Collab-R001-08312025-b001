    ...
    return(
      <div className='user-show'>
        ...
        <div className='user-show__details'>
          ...
          <div className='user-show__details-value'>{moment(user.last_seen_at || Date.now()).format('DD MMM YYYY - HH:mm')}</div>
        </div>
        <div className='user-show__details'>
          <Icon name='calendar-times-o' className='user-show__details-icon'/>
          <div className='user-show__details-label'>Joined</div>
          <div className='user-show__details-value'>{moment(user.created_at || Date.now()).format('DD MMM YYYY')}</div>
        </div>
      </div>
    )
  }
